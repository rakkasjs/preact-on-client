...
var _parts, _type, _size, _endings, _a, _lastModified, _name, _b, _d, _c, _path, _start;
import "http";
...
function createMiddleware(handler, options = {}) {
  ...
  return async (req, res, next) => {
    ...
    const request = new Request(protocol + "://" + host + req.url, {
      method: req.method,
      headers,
      body: req.method === "GET" || req.method === "HEAD" ? void 0 : req.socket ? req : new ReadableStream({
        start(controller) {
...
const File$1 = _File;
const File$1$1 = File$1;
/*! formdata-polyfill. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */
var { toStringTag: t, iterator: i, hasInstance: h } = Symbol, r = Math.random, m = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), f = (a, b, c) => (a += "", /^(Blob|File)$/.test(b && b[t]) ? [(c = c !== void 0 ? c + "" : b[t] == "File" ? b.name : "blob", a), b.name !== c || b[t] == "blob" ? new File$1$1([b], c, b) : b] : [a, b + ""]), e = (c, f2) => (f2 ? c : c.replace(/\r?\n|\r/g, "\r\n")).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), x = (n, a, e2) => {
  if (a.length < e2) {
    throw new TypeError(`Failed to execute '${n}' on 'FormData': ${e2} arguments required, but only ${a.length} present.`);
  }
};
const FormData$1 = (_c = class {
  constructor(...a) {
...
class Body {
  constructor(body, {
    ...
    if (body === null) {
      ...
      ;
    else if (body instanceof FormData$1) {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-60ea4e79.js");
...
let Request$2 = class Request2 extends Body {
      ...
      if (isRedirect(response_.statusCode)) {
        ...
        switch (request.redirect) {
          ...
          case "follow": {
            ...
            resolve(fetch$1(new Request$2(locationURL, requestOptions)));
            finalize();
            return;
          }
          default:
...
const fromBlob = (stat2, path, type = "") => new _Blob$1([new BlobDataItem({
  path,
  size: stat2.size,
  lastModified: stat2.mtimeMs,
  start: 0
})], { type });
const fromFile = (stat2, path, type = "") => new File$1$1([new BlobDataItem({
  path,
  size: stat2.size,
  lastModified: stat2.mtimeMs,
  start: 0
...
const Blob = globalThis.Blob || _Blob$1;
const File = globalThis.File || File$1$1;
const FormData = globalThis.FormData || FormData$1;
const Headers2 = globalThis.Headers || Headers$1;
const Request$1 = globalThis.Request || Request$2;
const Response2 = globalThis.Response || Response$1;
const AbortController$12 = globalThis.AbortController || AbortController$1$1;
const nodeFetch = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AbortController: AbortController$12,
  AbortError,
  Blob,
  FetchError,
  File,
...
function install2() {
  ...
  if (globalThis.Response)
    return;
  class Response22 extends Response2 {
    constructor(input, init) {
  ...
  Object.defineProperty(Response22, "name", {
    value: "Response",
    writable: false
  });
  define("Response", Response22);
  define(
    "fetch",
    (input, init) => fetch(input, init).then((r2) => {
      Object.setPrototypeOf(r2, Response22.prototype);
      return r2;
    })
  );
}
...
function install$1() {
  ...
  const Headers3 = class MyHeaders extends globalThis.Headers {
    constructor(init) {
      super(init);
      if (!init) {
        return;
  ...
  const Response3 = class extends globalThis.Response {
    constructor(body, init) {
      super(body, init);
      const headers = new Headers3(init == null ? void 0 : init.headers);
  ...
  Object.defineProperty(Response3, "name", {
    value: "Response",
    writable: false
  });
  const originalFetch = globalThis.fetch;
  Object.defineProperty(globalThis, "Headers", { value: Headers3 });
  Object.defineProperty(globalThis, "Response", { value: Response3 });
  Object.defineProperty(globalThis, "fetch", {
    value: (input, init) => originalFetch(input, init).then((r2) => {
      Object.setPrototypeOf(r2, Response3.prototype);
      const headers = new Headers3(r2.headers);
...
const entryNode_default = createMiddleware(
  (req, res, next) => import("../hattip.js").then((n) => n.e).then((m2) => m2.default(req, res, next))
);
